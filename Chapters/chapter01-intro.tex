...
One line of evidence pointing to a clumpy BLR structure is the absence of broad \ion{C}{IV} absorption in the majority of objects.
If BLR were completely uniform one might expect \ion{C}{IV} absorption to be ubiquitous.
