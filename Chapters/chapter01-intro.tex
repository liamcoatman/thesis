...
First quasars discovered almost 60 years ago (1963). 
Very far away and bright implies enormous luminosities. 
Variability on time-scales of weeks suggests a very compact source. 
Accretion on to super-massive black holes at the centres of galaxies quickly suggested (e.g. Lynden-Bell 1969). 

Seyfert galaxies were known about at the time (1943; Carl Seyfert). 
...
In 70s it was thought that quasars were weird galaxies that for some reason had black holes at their centres. 
Begining in the early 1990s, extinct black holes were found in the centres of many nearby massive galaxies \citep[e.g.][]{kormendy95,ferrarese05,kormendy13}.
Suggests that quasar activity is a stage in the life of massive galaxies, as proposed in the late 1960s (Lynden Bell 1969).  

Kormendy in 1993 discovered that black hole masses and bulge masses were correlated. 
In order for MBH and Bbulge to grown in sync, suggested that energetic feedback from the black hole regulates both star frmation in the bulge and the growth of the black hole itself.
The insigt that quasars thus play a crucial role in the evolution of galaxies led to an explosion in interest in quasars. 
This importance of this discovery is that it suggests a coeval evolution for bulges and SMBHs through feedback \footnote{Although there are claims that M-sigma is a selection effect. Need to resolve the sphere of influence and maybe only most massive have been measured.} 

Recent claims that BH might drive large scale molecular outflows (give references). 
...
theory of accretion disc winds has long histroy, but really gained holdin the late 1990s, with a sueries of publications my Murray and collaborators (see refs p128). 
There is partially inoised material around accretion disk, including tripally ionsied carbon. 
UV photons from acretion disk excite electrons in the atoms, and as areuslt will exert a pressure on the atom itself - radiation line driving.  
result is that a wind can be blown from the accretion disk. 
process is very efficient as long as atoms are not complelet inoised. if this happens there are no electons left in the atoms to produce ratioation pressure from spectral lines. 
This, the wind is senstive to the ratio of the UV to X-ray continuum. 
...
Low ionisatin lines arise in a different region, perhaps further out, in some sort of disc.  

Accretion disc winds provide a unifying model for all emission and absorption features - e.g. elvis 2000

The radiative energy released may have a dramatic effect on surroundings. Little doubt about this. But can mechanical and radiative output effect the entire bulge? This question has arisin in the last 10-15 years. 
...
Remarkably, given the sphere-of-influence \marginpar{sphere within which the gravity of the black hole will dominate the dynamics of the stars to a greater etent than the other mass components (stars, gas)} of the BH is many orders of magnitude smaller than the size of the galaxy, the BH mass and mass of the host galaxy spheroid are strongly correlated \citep{ferrarese00,gebhardt00,graham01,tremaine02,marconi03,aller07,gultekin09}.  
...
This establishes another connection between BH and galaxy properties. 
...
The central location of quasars in their host galaxies and the fact that they can produce a large amount of energy imply that quasars can play a dominant role in determining the physical conditions of matter, not only in the quasar vicinity but also on galactic and even intergalactic scales.  
BALs etc indiate that quasar continuum radiation affects the quasars immediate environment.  
  
Quasars could provide such feedback precisely because they are very powerful sources of energy and momentum
At present, the physical processes involved are not well understood. 
We don't know if quasar disk winds are strong and persistent enoujgh to deliver energy over large radii. 
...
\subsection{Why these masses are important}
...
Origin of the M-sigma relationship still isn't clear, but how this relation changes with rdshift probably tells us something about how black holes and galaxie form and evolve over cosmic times. 
