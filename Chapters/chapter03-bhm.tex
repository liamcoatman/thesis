...
The \citet{vestergaard06} \ion{C}{IV} FWHM calibration uses the monochromatic continuum luminosity at $1350$\,\AA\, to predict the BLR radius and corresponds to ($a=6.66$, $b=2$, $c=0.53$) in Equation~\ref{eq:virialmass}. 
...
We use the corrected \ion{C}{IV} FWHM given by Equation~\ref{eq:hafwhm} as an indicator of the virial velocity, and adopt the same $R-L$ relation for the $1350$\,\AA\, continuum luminosity as \citet{vestergaard06} (i.e. $R \propto L^{0.53}$). 
...
Given measured \ion{C}{IV} emission-line FWHM and blueshift, Equations~\ref{eq:hafwhm} and \ref{eq:masscorrection} can then be used to provide an unbiased estimate of the quasar BH mass.
...
Given the $\Delta V \propto R_{\mathrm BLR}^{-0.5}$ virial relation, this leads to the prediction that the \ion{C}{IV} line widths should be $\simeq 1.4$ times broader than \ha for a given BH mass, and this expectation is reflected in the \citet{vestergaard06} BH mass calibrations.
...
This picture is therefore consistent with the low \ion{C}{IV}/\ha FWHM ratio observed in our sample of quasars with modest \ion{C}{IV} blueshifts. 
...
\caption{Composite spectra from Ly$\alpha$ to \ion{C}{III} for quasars with different \ion{C}{IV} blueshifts. The systematic variation in the \ion{C}{IV} shape is correlated with changes in the quasar SEDs.}
...
The large systematic variation in the \ion{C}{IV} emission-line profile is evident in Figure~\ref{fig:blueshift_composite}.
The systematic variation in the \ion{C}{IV} shape is correlated with changes in the quasar SEDs, including the strengths of the \ion{Si}{III}$\lambda$$1892$ and \ion{C}{III}$\lambda$$1908$ emission-lines in the rest-frame ultraviolet. 
...
For the \citet{hewett10} redshifts, and ultraviolet emission-line based redshifts in general, quasars with large \ion{C}{IV} EQW and modest blueshifts have relatively small ($\simeq300$\,\kms) SED-dependent redshift errors.
...
In a forthcoming work, Allen \& Hewett (2017, in preparation) will present a new redshift-estimation algorithm that produces redshifts independent of the \ion{C}{IV} blueshift and other variations in the ultraviolet SEDs of luminous quasars.
...
The two-dimensional nature of the \ion{C}{IV} emission-line parametrization and the apparent anti-correlation between \ion{C}{IV} EQW and \ion{C}{IV} blueshift suggests that the quasar population exhibits a continuum of properties. 
...
To test this hypothesis, we selected 18 \ion{C}{IV} BAL quasars from our catalogue with near-infrared spectra including \hb. 
...
\begin{itemize}
 ...
 \item[28-29] \ion{C}{IV} blueshift, relative to \hans, and its error, in \kms.

 \item[30-31] \ion{C}{IV} blueshift, relative to \hbns, and its error, in \kms.

 \item[32-33] Uncorrected \ion{C}{IV}-FWHM-based BH mass using \citet{vestergaard06} calibration, and its error.

 \item[34-35] Corrected \ion{C}{IV}-FWHM-based BH mass, and its error.
...
\begin{table*}
  ...
  \label{tab:bhm-specmeasure}
   \begin{tabular}{cccc} 
    ...
    10 & SNR\_FLAG\_Ha & & \ha S/N flag \\  % (Remove 2, just flag 1 as low S/N)
    ...
    19 & SNR\_FLAG\_Hb & & \hb S/N flag \\  % (Remove 2, just flag 1 as low S/N)
