...
\begin{figure}
    \centering 
    \includegraphics[width=0.8\linewidth]{figures/chapter03/ha_z_comparison.pdf} 
...
\todo{Update this for big sample}
The differences in the \ha emission-profile as a function of \ion{C}{IV}-blueshift appear to be systematic.
...
The \ion{C}{IV} line profiles of the quasars with  the largest \ion{C}{IV} blueshifts demonstrate that non-virial motions are having a significant effect on the \ion{C}{IV} BLR dynamics. 
...
\todo{Update based on big sample}
