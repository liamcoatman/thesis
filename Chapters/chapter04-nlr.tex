...
\begin{table}
  ...
  \footnotesize 
    ...
    \hline
    \end{tabular}
    \caption[{Summary of models used to fit the [\ion{O}{III}] emission, and the number of quasars each model is applied to.}]{Summary of models used to fit the [\ion{O}{III}] emission, and the number of quasars each model is applied to.}
  \label{tab:oiiimod}
\end{table} 
