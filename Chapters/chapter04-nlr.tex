...
These findings therefore appear to support the idea that strong feedback is occuring in this population of heavily reddened quasars. 
...
The EQW cut removes most of the quasars with large \ion{C}{IV} blueshifts, since [\ion{O}{III}] is on average very weak in these quasars. 
...
\todo{Manda/Paul: Estimate a time-scale for how long the NLR would take to be cleared given typical size of galaxy and velocity of outflow}. 
...
The second model consists of six spectral components derived from an ICA of a large sample of low-redshift AGN with SDSS spectra covering the same spectral region.
