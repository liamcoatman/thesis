...
\todo{Need to finish defining samples}
...
We exclude [\ion{O}{III}], \hb and \ha measurements when the uncertainties on the peak velocities exceed 400, 750 and 400 \kms respectively. 
This removes 8, 12 and 35 per cent of objects in (a), (b) and (c) respectively. 
We also exclude [\ion{O}{III}] measurements from 16 objects with very broad, blueshifted [\ion{O}{III}] emission that is strongly blended with the red wing of \hbns (these objects are discussed in Section~\ref{sec:extreme_oiii}). 
The uncertainties on these redshifts are large and almost certainly strongly biased. 
...
Properties of the [\ion{O}{III}] emission (EQW, $w_{80}$ and asymmetry) are shown in Figure~\ref{fig:parameter_hists}. 

The [\ion{O}{III}] EQW follows an approximately log-normal distribution, peaking at 17\AA. 
In XX per cent of our sample [\ion{O}{III}] is very weak, with EQW $<$ XX \AA. 
...
In this section we compare the [\ion{O}{III}] properties of our quasar sample with a sample of AGN at lower redshifts with lower luminosities. 
...
The \citet{mullaney13} catalogue contains [\ion{O}{III}] line measurements for $\sim$25\,000 SDSS spectra. 
...
The \ion{C}{IV} blueshift and EQW is a diagnostic that similarly spans the diversity of broad emission line properties in high redshift quasars \citep[dominated by a virialized component at one extreme and a wind driven component at the other][]{richards11,sulentic07}. 
