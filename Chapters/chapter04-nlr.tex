...
All [\ion{O}{III}] line properties are derived from the [\ion{O}{III}]\l5008 emission, but, as described above, the kinematics of [\ion{O}{III}]\l4960 are constrained to be identical in our fitting routine. 
...
\todo{Decide whether this should be ditched}
...
\todo{Re-running errors with model. When finish get new sigmas on EQW.}
...
Netzer suggested that ... and our results appear to be consistent with this picture. 
