...
\begin{table}
  \centering
  \small
  \caption{The format of the table containing the emission line properties from our parametric model fits. \todoinline{Copy format of Shen et al. (2011). Give all velocities relative to [\ion{O}{III}] peak?}}
...
\todo{Need to change reference and explain new figure.}
...
We choose cut-offs of 750, XX and 400 for errors on the \hbns, \ha and [\ion{O}{III}] peaks respectively. 
\todo{Do Ha when simulations finish.}
...
\todo{Ask Paul what to say about offset.}
...
\begin{itemize}
  ...
  \item[25-26] Dimensionless asymmetry of [\ion{O}{III}] ($A = (v_{90} + v_{10}) / (v_{90} - v_{10})$), and its.  
