...
\todo{These are all IFU. Studies with 1D spectra?}

Models suggests that AGN efficiency in driving galaxy-scale outflows increase with AGN luminosity 
(e.g. Hopkins et al. 2016) and the [\ion{O}{III}] emission in more luminous AGN tends to have larger widths \citep[e.g.][]{shen16a,zakamska14,zakamska16}. 

Recent studies have looked at the [\ion{O}{III}] emission properties of rare sub-samples - e.g. heavily obscured quasars \citep{zakamska16} and the most luminous quasars \citep{bischetti16}. 
Our more representative sample will help to put these observations in context of the AGN population as a whole. 

As well as looking at the [\ion{O}{III}] velocity width and asymmetry, [\ion{O}{III}] is undetected. 
The fraction of quasars with weak [\ion{O}{III}] is probably luminosity-dependent. 


The [\ion{O}{III}]\ll4960,5008 doublet is the strongest narrow line in optical quasar spectra.
