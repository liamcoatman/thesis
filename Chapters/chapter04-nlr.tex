...
We not that there is a similarity between these objects and the four quasars presented in \citet{zakamska16}. 
...
\begin{figure}
    ...
    \caption{The strength [\ion{O}{III}] EQW as a function of the \ion{C}{IV} blueshift. The \ion{C}{IV} blueshift is measured relative to the NIR \ac{ICA} redshift.}     
...
Is the \ac{AGN} \ac{NLR} absent in objects where outflows have reached kiloparsec scales, sweeping up the low-density material responsible for the [\ion{O}{III}]-emission?
