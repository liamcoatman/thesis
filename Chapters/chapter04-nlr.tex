...
\todo{Paul: what is the definition of detected?}
When detected, [\ion{O}{III}] is typically very broad, with a prominent blue wing to the emission.  

In Figure~\ref{fig:parameters_grid} we show correlations between the [\ion{O}{III}] $w_{80}$, EQW, asymmetry for 119 quasars: objects with \ac{EQW} $<$ 8\AA or poor \ion{Fe}{II} subtraction are not included. 
...
\begin{figure}
    ...
    \caption{\todoinline{Need to change systemtic redshift to \ha and \hb}}     
