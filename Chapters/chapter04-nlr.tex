%************************************************
\chapter{Narrow line region properties}\label{ch:nlr} 
%************************************************
...
The [\ion{O}{III}]\ll4960,5008 doublet is the strongest feature found in optical quasar spectra.
...
As far as we are aware, this is the largest study of the narrow line region properties of high-$z$ quasars ever undertaken. 
...
\begin{table}
  \centering
  \caption{The numbers of quasars with [\ion{O}{III}] line measurements and the spectrographs and telescopes used to obtain the near-infrared spectra. Further details on the instrumental configurations are given in paper I. }
  \label{tab:specnums}
    \begin{tabular}{ccc} 
    \hline
...
{\bf Bigger than expected uncertainty in Ha redshifts because of uncertain decomposition in to \ha broad/narrow and [\ion{N}{II}] emission?}
...
\ha and \hb seem to give no systematic offset but large scatter, and they are often asymmetric, so should only use peak. And \ha isn't always available, and have other narrow components need to decompose.
