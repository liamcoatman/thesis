...
Previous investigations of the rest-frame optical spectra of quasars at redshifts $z\sim2$ have typically used samples of a few dozen \citep[e.g.][]{shen16a}. 
...
The luminosity and redshifts of the quasars in the sample are shown in Fig.~\ref{fig:lzplane}. 
...
The telescopes and instruments used to observe these spectra are summarised in Table~\ref{tab:specnums} and the information on the individual spectra is provided in Table~\ref{tab:data_summary}.
...
We selected quasars from the spectroscopic quasar catalogue of the SDSS Seventh Data Release \citep[DR7;][]{schneider10} with a wide range of \ion{C}{IV} blueshifts. 
\todo{Does the reader know about \ion{C}{IV} blueshifts?}
...
The removal of quasars with significant dust extinction was achieved by identifying quasars with $i-K$ colours redder than a parametric spectral energy distributions (SED) model + SMC-like extinction curve with \ebv=0.05 (the SED model is described in Chapter~\ref{ch:hotdust}). 
