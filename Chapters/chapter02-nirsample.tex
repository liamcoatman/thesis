...
\chaptermark{Near-inrared spectroscopic database}
\label{ch:nirsample}
%*****************************************
...
The remaining data was processed with algorithms in the LowRedux\footnote{www.ucolick.org/\textasciitilde xavier/LowRedux} package \citep[see][]{prochaska09}\footnote{Spectra in this sample were reduced by Prof. J Hennawi, Prof. X. Prochaska and collaborators.}.
...
The spectra were reduced using a custom pipeline, again using algorithms in the LowRedux package\footnote{Spectra in this sample were reduced by Prof. X. Prochaska and collaborators.}. 

\section{Redshift and luminosity distribution of catalogue}
\sectionmark{Redshift and luminosity distribution}
...
\sectionmark{Absolute flux calibration}
...
\sectionmark{Instrumental broadening}
