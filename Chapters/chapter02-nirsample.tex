...
% ID
% Make sure nothing depends on z_IR

% CIV v50 relative to OIII peak velocity 




% OIII_FIT_HA_MODEL
% OIII_FIT_HA_NGAUSSIANS
% OIII_FIT_HA_FIX_BROAD_PEAKS
% OIII_FIT_HA_BROAD_OFFSET
% OIII_FIT_HA_REDCHI
...
% # Check these are the values going in to figure 6 in paper 
% LogMBH_Ha
% LogMBH_Ha_Err
% Edd_Ratio_Ha
% Edd_Ratio_Ha_Err
...
% LogMBH_CIV_VP06_Err
% Edd_Ratio_CIV_VP06
% Edd_Ratio_CIV_VP06_Err

% # Add corrected BH mass 

% FWHM_Broad_Ha
% FWHM_Broad_Ha_Err
% Sigma_Broad_Ha
% Sigma_Broad_Ha_Err
% Median_Broad_Ha (remove z_IR dependence)
% Median_Broad_Ha_Err
% Peak_Broad_Ha
% Peak_Broad_Ha_Err
% EQW_Broad_Ha
...
% LogL_Narrow_Ha
% LogL_Narrow_Ha_Err
% VOFF_Narrow_Ha (remove z_IR dependence)
% VOFF_Narrow_Ha_Err

% RedChi_Ha
% WARN_Ha (Remove 2, just flag 1 as low S/N)
% SNR_Ha
% dv_Ha
% Model_Ha

% # These will be repeated in chapter 4 with slightly different model 
% z_Broad_Ha
% z_Broad_Hb
...
% (remove best, make sure it's clear where it comes from)
% FWHM_CIV_BEST
% FWHM_CIV_BEST_Err 
% Sigma_CIV_BEST
% Sigma_CIV_BEST_Err
...
% RedChi_CIV_BEST
% WARN_CIV_BEST (will have removed warn=2, so should just be warn=1 low S/N flag)
% BAL_BEST
% SNR_CIV_BEST
% dv_CIV_BEST
...
% Make sure this is BEST: 
% 1400: Make sure best and just give what I used in paper. 
% If people want anything else they can generate it from my parameters and the code I give 


% EQW_FE_4434_4684
% EQW_FE_4434_4684_Err




% OIII_FIT_HB_BROAD_OFFSET_ERR
...
% FWHM_CIV_BEST_Err_New
% Median_CIV_BEST_Err_New
% FWHM_CIV_BEST_Err_New.1
% Median_CIV_BEST_Err_New.1
% Blueshift_CIV_HW_DR7_Paul
% EQW_CIV_HW_DR7_Paul
% Blueshift_CIV_ICA_DR7_Paul
% EQW_CIV_ICA_DR7_Paul
% z_ICA_DR7
...
% Blueshift_CIV_Ha
% Blueshift_CIV_Ha_Err

% Blueshift_CIV_Hb
% Blueshift_CIV_Hb_Err

% Blueshift_CIV_OIII
% Blueshift_CIV_OIII_Err

% Blueshift_CIV_ICA_DR7
% Blueshift_CIV_ICA_DR10
% Blueshift_CIV_ICA_DR12
% Blueshift_CIV_HW
% Blueshift_CIV_ICA
% Blueshift_CIV_Balmer_Best
...
% Just give BEST values then note of which optical spectrum was used
...
% Don't need to give any other Hb properties, just make sure give model parameters and code to generate spectra. 

% Make table of OIII line properties and provide code to turn these in to spectrum. When OIII_Broad_OFF just set amplitude of second component to zero. Check none with FIX_OIII_PEAK_RATIO=True. 

% Details of model, oiii ngaussians, hb ngaussians, hb fix centroids. 