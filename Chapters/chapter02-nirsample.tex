...
In the first approach, we leverage the excellent flux-calibration of SDSS/BOSS spectra, which are available for 68 per cent of our objects. 
...
fitting an SED-model to the optical-infrared photometry. 
