...
\begin{landscape}% Landscape page
    ...
    \captionof{table}{Quasars in our near-infrared spectroscopic database. Only the first $15$ entries are shown. The full table (including $462$ objects) is available on-line. \todoinline{Maybe DVD?}}
    \label{tab:database}
...
\begin{enumerate}
 ...
 \item Spectra taken with VLT/XSHOOTER. The XSHOOTER spectra are moderate resolution (R$\simeq6000$) and cover the full optical-near-infrared spectral region ($0.30-2.50$\,micron). 
