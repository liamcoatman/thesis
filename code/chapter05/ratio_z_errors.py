def plot():
    ...
    tab = Table.read('/data/lc585/QSOSED/Results/150309/sample1/out_add.fits')
    ...
    xyrange = [[0,2],[0,3]] # data range
    bins = [70,70] # number of bins
    ...
    modtab = Table.read('/data/lc585/QSOSED/Results/150309/sample2/out_add.fits')
    ...
    ax.errorbar(locx[:-1] + 0.1,np.repeat(1.5,12),yerr=ys,linestyle='',color='black')
    ...
    fig.savefig('/home/lc585/thesis/figures/chapter06/ratio_z_errors.pdf')
