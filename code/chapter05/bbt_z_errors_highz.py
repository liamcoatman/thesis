def plot():
    ...
    tab = Table.read('/data/lc585/QSOSED/Results/150217/sample1/out_add.fits')
    ...
    xyrange = [[1,5],[100,5000]] # data range
    bins = [140,100] # number of bins
    ...
    ax.errorbar(locx[:-1] + 0.1,np.repeat(1800,13),yerr=ys,linestyle='',color='black')
    ...
    fig.savefig('/home/lc585/thesis/figures/chapter06/bbt_z_errors_highz.pdf')
