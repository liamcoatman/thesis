...
def plot():
    ...
    m1, m2 = tab1['LUM_UV'], tab1['RATIO_IR_UV']
    ...
    m1, m2 = tab2['LUM_UV'], tab2['RATIO_IR_UV']
    ...
    m1, m2 = tab1['LOGBH'], tab1['RATIO_IR_UV']
    ...
    m1, m2 = tab2['LOGBH'], tab2['RATIO_IR_UV']
    ...
    m1, m2 = tab1['LOGEDD_RATIO'][ tab1['LOGEDD_RATIO'] > -2.0] , tab1['RATIO_IR_UV'][ tab1['LOGEDD_RATIO'] > -2.0]
    ...
    m1, m2 = tab2['LOGEDD_RATIO'][ tab2['LOGEDD_RATIO'] > -2.0] , tab2['RATIO_IR_UV'][ tab2['LOGEDD_RATIO'] > -2.0]
    ...
    axs[2].set_xlim(-1.5,0.5)
    
    axs[0].set_ylabel('NIR/UV Lumionsity Ratio')
    ...
    fig.savefig('/home/lc585/thesis/figures/chapter06/ratio_correlations_contour.pdf')
