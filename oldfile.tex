...
\begin{figure}
  ...
  \caption[{Best-fit blackbody temperature against UV luminosity, black-hole mass and Eddington ratio.}]{Best-fit blackbody temperature against UV luminosity (left), black-hole mass (centre) and Eddington ratio (right) for $1 < z < 1.5$ sample (black) and $2 < z < 2.7$ sample (black). \todoinline{Needs re-making with new BH masses.} \todoinline{Maybe just show as one sample?}}
